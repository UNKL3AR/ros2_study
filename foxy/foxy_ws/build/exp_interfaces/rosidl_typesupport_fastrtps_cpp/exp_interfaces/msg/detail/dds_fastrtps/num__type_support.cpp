...
#include "exp_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const exp_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<exp_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  return &exp_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
